...
import com.demo.swagger.model.Pet;
import com.demo.swagger.model.Pets;
import com.demo.swagger.repository.MapBackedRepository;

@Controller
@RequestMapping(value = "/api/pet", produces = {APPLICATION_JSON_VALUE})
...
public class PetController {
	...
	public ResponseEntity<List<Pet>> findPetsByStatus(
			@ApiParam(value = "Status values that need to be considered for filter",
					...
					allowMultiple = true) @RequestParam("status") String status) {
	...
	public ResponseEntity<List<Pet>> findPetsByTags(
			@ApiParam(
					...
					required = true,
					allowMultiple = true) @RequestParam("tags") String tags) {
